...
interface JournalState {
    ...
    saveMealRecord: (date: string, patientId: string, mealTime: 'morning' | 'lunch' | 'dinner', record: MealRecord) => void;
    saveMedicalRecord: (date: string, patientId: string, record: MedicalRecord) => void;
    saveActivityRecord: (date: string, patientId: string, record: ActivityRecord) => void;
...
const MOCK_ENTRIES: JournalEntry[] = [
    {
        ...
        specialNotes: '37.8도로 매일저체 추가 필요',
