...
export default function CareerScreen() {
    ...
    const [hasExperience, setHasExperience] = useState(careerInfo?.hasExperience ?? false);

    // 선택된 자격증 (id -> image 매핑)
    const [certificateImages, setCertificateImages] = useState<Record<string, CertificateImage | null>>({});
