    ...
    return (
        <SafeAreaView className="flex-1 bg-white" edges={['bottom']}>
            ...
            <ScrollView className="flex-1 px-6 pt-6">
                ...
                {/* Name Field */}
                <View className="mb-4">
                    <Text className="text-sm font-bold mb-2 text-gray-800">이름</Text>
                    <Controller
                        control={control}
                        name="name"
                ...
                {/* Phone Field */}
                <View className="mb-4">
                    <Text className="text-sm font-bold mb-2 text-gray-800">휴대폰</Text>
                    <Controller
                        control={control}
                        name="phone"
                        render={({ field: { onChange, onBlur, value } }) => (
                ...
                {/* Address Field */}
                <View className="mb-4">
                    <Text className="text-sm font-bold mb-2 text-gray-800">주소</Text>
                    <Controller
                        control={control}
                        name="addressDetail"
                        render={({ field: { onChange, value } }) => (
